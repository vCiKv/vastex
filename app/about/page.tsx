...
import { FaPeopleGroup, FaListCheck, FaShieldHalved, FaMoneyBill1Wave } from "react-icons/fa6";
import {
  Dialog,
  DialogClose,
  DialogContent,
          ...
          <Dialog>
            ...
            <DialogContent hideClose className="bg-transparent backdrop-blur-md h-[90vh] md:h-[95vh] md:max-w-[800px] overflow-auto fixed rounded-2xl p-0 scroll-smooth border-transparent" >
              <div className="relative size-full w-full ">
                ...
                <div className="space-y-3 px-4 pt-4 md:px-6 md:pt-6 pb-10 bg-white">
                  <div>
      ...
      <main className="flex-1">
        ...
        <Section containerClassName="relative overflow-hidden bg-white py-0 md:py-0">
          ...
          <div className="container relative z-10 px-4 md:px-6 pt-8">
            <div className="grid gap-6 grid-col-2 md:grid-cols-3 lg:gap-12 xl:gap-16">
        ...
        >
          <div className="grid grid-cols-1 px-6 md:px-8 gap-12 pb-12 size-full">
            <div className="border-0 rounded-xl py-2 group bg-white md:w-fit">
